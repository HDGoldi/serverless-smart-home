 ...
 */
import { OnDestroy, OnInit, ElementRef, SimpleChanges, OnChanges, DoCheck } from '@angular/core';
 ...
 */
export declare class NbInputDirective implements DoCheck, OnChanges, OnInit, OnDestroy, NbFormFieldControl {
    ...
    fullWidth: boolean;
    private _fullWidth;
    constructor(elementRef: ElementRef<HTMLInputElement | HTMLTextAreaElement>, focusMonitor: NbFocusMonitor);
    ngDoCheck(): void;
