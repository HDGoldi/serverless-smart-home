...
var NbFormFieldComponent = /** @class */ (function () {
    function NbFormFieldComponent(cd) {
        var _this = this;
        this.cd = cd;
    ...
    NbFormFieldComponent.prototype.subscribeToFormControlStateChange = function () {
        ...
        }), distinctUntilChanged(function (oldState, state) { return _this.isStatesEqual(oldState, state); }), takeUntil(this.destroy$))
    ...
    NbFormFieldComponent.prototype.getAddonClasses = function (addon, state) {
        var classes = [
            'nb-form-field-addon',
    ...
    NbFormFieldComponent.prototype.isStatesEqual = function (oldState, state) {
